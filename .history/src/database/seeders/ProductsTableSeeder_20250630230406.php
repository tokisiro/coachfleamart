...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param =[
            'user_id' => $faker->randomElement($userIds),
            'image' => 'storage/app/Computer.jpg',
            'brand_name' => '',
            'situation' => '良好',
            'product_name' => 'ノートPC',
