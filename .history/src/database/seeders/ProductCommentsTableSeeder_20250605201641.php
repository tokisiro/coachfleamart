...
class ProductCommentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Illuminate\Support\Facades\DB::table('product_comments')->truncate();
        ...
        $comments = [
            ...
            '本日、商品が無事に届きました。迅速に対応していただきありがとうございます。丁寧に梱包されており、商品もイメージ通りでした。
            また機会がありましたら、よろしくお願いいたします。',
            '商品を受け取りました。ありがとうございました。
            ただ発送予定日より3日遅れての発送で、届くまで不安がありました。遅れる場合には事前にご連絡いただけるとよかったです。',
            ];
