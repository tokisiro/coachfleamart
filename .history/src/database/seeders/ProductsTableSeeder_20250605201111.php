...
Class 'Database\Seeders\Schema' not found

at database/seeders/ProductsTableSeeder.php:18
   14▕      * @return void
   15▕      */
   16▕     public function run()
   17▕     {
➜  18▕         Schema::disableForeignKeyConstraints();
   19▕         \Illuminate\Support\Facades\DB::table('products')->truncate();
   20▕         Schema::enableForeignKeyConstraints();
   21▕ 
   22▕         $faker = FakerFactory::create();

    +7 vendor frames 
8   database/seeders/DatabaseSeeder.php:18
    Illuminate\Database\Seeder::call("Database\Seeders\ProductsTableSeeder")
