...
class ItemController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $mode = $request->input('tab'); // 'recommendation' or 'liked'
    if (!$mode) {
        $mode = 'recommendation'; //デフォルト設定
    }
    ...
    if($mode == 'liked') {
        ...
        $products = $liked_products; //マイリストの場合はliked_productsを使う
    } else {
    ...
    // viewに渡す
    return view('product', compact('products', 'liked_products', 'searchTerm', 'mode'));
}
