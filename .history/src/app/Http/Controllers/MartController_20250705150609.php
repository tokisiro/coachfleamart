...
class MartController extends Controller
{
    ...
    if ($request->hasFile('icon')) {
        ...
        return view('product',compact('products','liked_products','currentTab'));
    }
    ...
    public function list(Request $request){
        ...
        return view('product',['products' => $products, 'liked_products' => [], 'mode'=>'recommendation']);
    }
    ...
    public function liked(){
        ...
        return view('product',['products' => [], 'liked_products' => $liked_products, 'mode'=>'liked']);
    }
