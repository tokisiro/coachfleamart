...
// 取引完了API
Route::post('/api/transaction/{productId}/complete', [ItemController::class, 'completeTransaction'])->middleware('auth');

// 評価送信API
Route::post('/api/transaction/{productId}/rate', [ItemController::class, 'rateUser'])->middleware('auth');

Route::middleware('auth:sanctum')->group(function () {
    Route::post('/transaction/{product}/rate', [ProductController::class, 'rateProduct']);
    // 他の認証が必要なAPIルート...
});