...
//初回住所情報登録機能
Route::middleware(['auth', 'verified'])->post('/mypage/profile', [ItemController::class, 'update']);
...
//メール認証機能
Route::get('/verify-email/{id}/{token}', [ItemController::class, 'verifyEmail'])->name('email');

// 
Route::get('/resend-verification/{id}', [YourController::class, 'resendVerificationEmail'])->name('resendVerification');
