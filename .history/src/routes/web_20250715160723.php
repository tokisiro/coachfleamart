...
//プロフィール変更機能
Route::post('/profile/update',[ItemController::class,'update']);
...
//コメント追加機能
post('/comment', [ItemController::class, 'comment']);

//stripeを使った購入機能
Route::post('/create-checkout-session', [ItemController::class, 'createCheckoutSession']);

//購入機能更新機能　調整中
Route::match(['get', 'post'],'/buy/{product}', [ItemController::class,'purchase'])->name('product.purchase');
