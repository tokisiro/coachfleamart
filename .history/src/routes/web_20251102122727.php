...
// 取引画面表示ルート
Route::get('/transaction/{productId}', [TransactionController::class, 'identification'])->name('identification');

// 取引完了API
Route::post('/api/transaction/{productId}/complete', [TransactionController::class, 'completeTransaction'])->middleware('auth');

// 評価送信API
Route::post('/api/transaction/{productId}/rate', [TransactionController::class, 'rateUser'])->middleware('auth');