...
// メッセージ更新（PUT/PATCH）
Route::put('/messages/{message}', [MessageController::class, 'update'])->name('messages.update'); // {message} はMessageモデルのID

// メッセージ削除（DELETE）
Route::delete('/messages/{message}', [MessageController::class, 'destroy'])->name('messages.destroy'); // {message} はMessageモデルのID