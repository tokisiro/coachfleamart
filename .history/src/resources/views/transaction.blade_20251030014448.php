    ...
    <div class="transaction-main">
        ...
        <form class="transaction-main__message" id="messageForm" action="{{ route('messages', $detail->id) }}" method="POST">
            ...
            <div class="transaction-main__message-input">
                <input class="transaction-main__message-input--text" name="message" type="text" id="messageInput" placeholder="メッセージを入力">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    formData.append('product_id', productId); // サーバー側で取得できるが、念のため
    ...
    if (selectedImageFile) {
        ...
        if (data.message.image) {
            messageHtml += `<div class="transaction-main__message-chat--item-image">
                                <img src="${data.message.image}" alt="送信画像" style="max-width: 200px; height: auto;">
                            </div>`;
        }
    ...
    function handleEditClick(event) {
        ...
        if (newMessage !== null && newMessage.trim() !== '' && newMessage.trim() !== currentMessage) {
            ...
            .then(data => {
                ...
                messageElement.innerText = data.message.message;
            })
            .catch(error => {
