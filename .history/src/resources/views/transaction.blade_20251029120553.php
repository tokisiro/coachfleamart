...
<div class="transaction">
    ...
    <div class="transaction-main">
        ...
        <form class="transaction-main__message" id="messageForm" action="{{ route('messages.store', $detail->id) }}" method="POST">
            ...
            <input class="transaction-main__message_item" name="message" type="text" placeholder="メッセージを入力">
