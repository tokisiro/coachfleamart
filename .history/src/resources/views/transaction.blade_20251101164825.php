...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const roleAsReviewedInput = ratingForm.querySelector('input[name="role_as_reviewed"]'); // 追加
    ...
    const isCurrentUserRated = {{ $isCurrentUserRated ? 'true' : 'false' }}; // ログインユーザーが評価済みか
