    ...
    <div class="setting">
        ...
        <form class="setting-form" action="/mypage/profile" method="post">
            ...
            <div class="setting-form__address">
                ...
                <input class="setting-form__address-input" type="text" value="{{ old('address', $user->post_code ?? '') }}">
            </div>
            <div class="setting-form__building">
                <label class="setting-form__building-label">
                    建物名
                </label>
                <input class="setting-form__building-input" type="text" value="{{ old('post_code', $user->post_code ?? '') }}">
            </div>
