    ...
    <form class="sell" action="/sell" method="post" enctype="multipart/form-data">
        ...
        <div class="sell-category">
            ...
            <div class="sell-category__checkbox">
                <input class="sell-category__checkbox-input" type="checkbox" id="category-fashion" name="category_ids[]" value="1">
                <label class="sell-category__checkbox-label" for="category-fashion">
                    ファッション
                </label>
                
                <input class="sell-category__checkbox-input" type="checkbox" id="category-appliances" name="category_ids[]" value="2">
                <label class="sell-category__checkbox-label" for="category-appliances">
                    家電
                </label>
                
                <input class="sell-category__checkbox-input" type="checkbox" id="category-interior" name="category_ids[]" value="3">
                ...
                <input class="sell-category__checkbox-input" type="checkbox" id="category-mens" name="category_ids[]" value="5">
                <label class="sell-category__checkbox-label" for="category-mens">
                    メンズ
                </label>
                <input class="sell-category__checkbox-input" type="checkbox" id="category-cosmetics" name="category_ids[]" value="6">
                <label class="sell-category__checkbox-label" for="category-cosmetics">
                    コスメ
                </label>
                <input class="sell-category__checkbox-input" type="checkbox" id="category-book" name="category_ids[]" value="7">
                <label class="sell-category__checkbox-label" for="category-book">
                    本
                </label>
                <input class="sell-category__checkbox-input" type="checkbox" id="category-game" name="category[]_ids" value="8">
                <label class="sell-category__checkbox-label" for="category-game">
                    ゲーム
                </label>
                <input class="sell-category__checkbox-input" type="checkbox" id="category-sports" name="category_ids[]" value="9">
                <label class="sell-category__checkbox-label" for="category-sports">
                    スポーツ
                </label>
                <input class="sell-category__checkbox-input" type="checkbox" id="category-kitchen" name="category_ids[]" value="10">
                <label class="sell-category__checkbox-label" for="category-kitchen">
                    キッチン
                </label>
                <input class="sell-category__checkbox-input" type="checkbox" id="category-handmade" name="category_ids[]" value="11">
                <label class="sell-category__checkbox-label" for="category-handmade">
                    ハンドメイド
                </label>
                <input class="sell-category__checkbox-input" type="checkbox" id="category-accessories" name="category_ids[]" value="12">
                <label class="sell-category__checkbox-label" for="category-accessories">
                    アクセサリー
                </label>
                <input class="sell-category__checkbox-input" type="checkbox" id="category-toy" name="category_ids[]" value="13">
                <label class="sell-category__checkbox-label" for="category-toy">
                    おもちゃ
                </label>
                <input class="sell-category__checkbox-input" type="checkbox" id="category-child" name="category_ids[]" value="14">
