...
@section('content')
    <div class="email">
        ...
        <div class="email-function">
            ...
            <form class="email-function__certification" action="{{ $verificationUrl }}" method="post">
                @csrf
                <button class="email-function__certification-item" type="submit">認証はこちらから</button>
            </form>
