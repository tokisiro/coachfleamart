...
@section('content')
    <div class="detail">
        ...
        <div class="detail-content">
            ...
            <form class="detail-content__information" action="{{ url('/purchase/' . $detail->id) }}" method="post">
                @csrf
            ...
            <form class="detail-content__comment" action="/comment" method="post">
                ...
                @foreach ($comments as $comment)
                    <div class="detail-content__comment-existing--icon">
                        <img class="detail-content__comment-existing--icon-img" src="{{ $comment->user->icon ? asset('storage/' . $comment->user->icon) : asset('storage/default.png') }}" alt="">
