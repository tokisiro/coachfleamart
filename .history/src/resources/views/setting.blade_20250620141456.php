    ...
    <div class="setting">
        ...
        <form class="setting-form" action="/mypage/profile" method="post" enctype="multipart/form-data">
            ...
            <div class="setting-form__icon">
                <img id="iconPreview" class="setting-form__icon-img" src="{{ $user->icon ? asset('storage/' . $user->icon) : asset('public/storage/default.png') }}" alt="">
                <!-- 目立たない隠しinput -->
                <input id="iconInput" class="setting-form__icon-input" type="file" name="icon">
                <!-- カスタムボタン -->
