    ...
    <div class="profile">
        <div class="profile-image">
            <div class="profile-image__icon">
                <img class="profile-image__icon-item" src="{{ $user->icon ? asset('storage/' . $user->icon) : asset('public/storage/default.png') }}" alt="">
            ...
            @forelse($purchasedProducts as $product)
                <a class="profile-list__Listing-card" href="">
                    <div class="profile-list__Listing-card--img">
                        <img class="profile-list__Listing-card--img-item" src="{{ $product->product_image }}" alt="" />
                    </div>
            ...
            @forelse($listedProducts as $product)
                <a class="profile-list__purchase-card" href="" >
                    <div class="profile-list__purchase-card--img">
                        <img class="profile-list__purchase-card--img-item" src="{{ $product->product_image }}" alt="" />
                    </div>
