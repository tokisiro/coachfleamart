    ...
    <div class="transaction-main">
        ...
        <div class="transaction-main__product">
            ...
            <div class="transaction-main__product-tag">
                <p class="transaction-main__product-tag--name">商品名</p>
                <p class="transaction-main__product-tag--price">表品価格</p>
            </div>
        </div>
        <form class="transaction-main__message" action="">
            ...
            <button>
                <img class="transaction-main__message-buttonitem" src="{{ asset('storage/paperairplane.png') }}" alt="紙飛行機">
            </button>
        </form>
    </div>
</div>
