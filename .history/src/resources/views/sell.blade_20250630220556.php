    ...
    <form class="sell" action="/sell" method="post" enctype="multipart/form-data">
        ...
        <div class="sell-category">
            <div class="sell-category__label">
                <label class="sell-category__label-item" for=category_ids[]"">
                    カテゴリー
                </label>
            </div>
            <div class="sell-category__checkbox">
                <input class="sell-category__checkbox-input" type="checkbox" id="category_ids[]" name="category_ids[]" value="ファッション">
