...
<main>
    <div class="detail">
        ...
        <div class="detail-content">
            ...
            <form class="detail-content__information" action="/purchase/{product}">
                <div class="detail-content__information-button">
                    <button class="detail-content__information-button--item" type="">
                        購入手続きへ
                    </button>
                </div>
            ...
            <form class="detail-content__comment" action="/comment">
