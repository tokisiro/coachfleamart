...
<main>
    <div class="detail">
        ...
        <div class="detail-content">
            <form class="detail-content__product" method="post" action="/nices">
            @csrf
                ...
                <div class="detail-content__product-evaluation">
                    <input class="detail-content__product-evaluation--nice" type="hidden" name="product_id" value="{{ $detail->id }}">
                        <button class="detail-content__product-evaluation--nice-button" type="submit">
                        @if($hasNice)
                            <img src="/storage/star_filled.png" alt="いいね済み" />
        @else
                            <img class="detail-content__product-evaluation--nice-button-img" src="/storage/star.png" alt="星">
                            @endif
                        </button>
