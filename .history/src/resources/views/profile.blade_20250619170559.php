    ...
    <div class="profile">
        ...
        <div class="profile-list">
            ...
            <div class="profile-list__Listing">
                <a class="profile-list__Listing-card" href="">
                    <div class="profile-list__Listing-card--img">
                        <img class="profile-list__Listing__card-img--item" src="" alt="" />
                    </div>
            ...
            <div class="profile-purchase" >
                <a class="profile-purchase__card" href="" >
                    <div class="profile-purchase__card-img">
                        <img class="profile-purchase__card-img--item" src="" alt="" />
                    </div>
                    <div class="profile-purchase__card-content">
                        <p class="profile-purchase__card-content--name">
                            商品名
                        </p>
                    </div>
                </a>
