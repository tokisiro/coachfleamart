...
@section('content')
    <div class="profile">
        ...
        <div class="profile-tag">
            <a id="ListingBtn" class="{{ $mode == 'sell' ? 'active' : '' }}" href="/mypage/?tab=sell">
                出品した商品
            </a>
            <a id="purchaseBtn" class="{{ $mode = 'buy' ? 'active' : '' }}" href="/mypage/?tab=buy">
                購入した商品
            </a>
        </div>
        <div class="profile-list">
            <!--出品した商品で表示するリスト-->
            <div class="profile-list__Listing" style="{{ $mode == 'Listing' ? '' : 'display:none;' }}">
            ...
            <!--購入した商品で表示するリスト-->
            <div class="profile-list__purchase" style="{{ $mode == 'purchase' ? '' : 'display:none;' }}">
