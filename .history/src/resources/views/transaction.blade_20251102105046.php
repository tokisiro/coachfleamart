        ...
        <div id="ratingModal" class="transaction-main__modal" style="display: none;">
            <div class="transaction-main__modal-content">
                ...
                {{-- hiddenで評価対象のユーザーIDと役割を送信 --}}
                    ...
                    <div class="transaction-main__modal-content--form-group">
                    ...
                    <button type="submit" class="modal-button modal-button--submit">評価を送信</button>
                </form>
                <button class="modal-button modal-button--cancel close-button">キャンセル</button>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const isCurrentUserRated = {{
        // ログインユーザーが評価済みか    $isCurrentUserRated ? 'true' : 'false' }};
