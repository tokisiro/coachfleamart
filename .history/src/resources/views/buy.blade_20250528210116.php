    ...
    <div class="buy">
        <div class="buy-content">
            ...
            <div class="buy-content__payment">
                <div class="buy-content__payment-item">
                    <label class="buy-content__payment-item--label">
                        支払い方法
                    </label>
                    <div class="buy-content__payment-item--input">
                    <input class="buy-content__payment-item--input" type="select">
                    </div>
                </div>
            </div>
        </div>
