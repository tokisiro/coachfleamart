    ...
    messageForm.addEventListener('submit', function(event) {
        ...
        .then(data => {
            ...
            if (data.message.message) {
                contentAndImageHtml += `<p class="transaction-main__message-chat--item-content">${data.message.message}</p>`;
            }
            // 画像がある場合、<img>タグを追加
            // data.message.image には保存された画像のURLが返されることを想定
            if (data.message.image) {
                contentAndImageHtml += `<img src="${data.message.image}" alt="送信画像" class="transaction-main__message-chat--item-image">`;
            }
            ...
            newMessageElement.innerHTML = `
                ...
                <div>
                    ...
                    <img src="{{ asset($message->image) }}" alt="送信画像" class="transaction-main__message-chat--item-image">${contentAndImageHtml}
                    <div class="transaction-main__message-chat--item-action">
