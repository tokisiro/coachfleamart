    ...
    <div class="register">
        ...
        <form class="register-form" action="" method="post">
            <div class="register-form__name">
                ...
                <input class="register-form__name-item" type="text" name="name">
            </div>
            <div class="register-form__email">
                <label class="register-form__email-label">
                    メールアドレス
                </label>
                <input class="register-form__email-item" type="email" name="email">
            </div>
            <div class="register-form__password">
                <label class="register-form__password-label">
                    パスワード
                </label>
                <input class="register-form__password-item" type="text" name="password">
            </div>
            <div class="register-form__confirmation">
                <label class="register-form__confirmation-label">
                    確認用パスワード
                </label>
                <input class="register-form__confirmation-item" type="text" name="password_confirmation">
            </div>
        ...
        <div class="register-link">
            <a class="register-link__login" href="">
                ログインはこちら
            </a>
        </div>
    </div>
