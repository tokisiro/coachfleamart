...
function showTab(tabName) {
    document.getElementById('listing').style.display = (tabName === 'listing') ? 'block' : 'none';
    document.getElementById('purchase').style.display = (tabName === 'purchase') ? 'block' : 'none';

    document.getElementById('ListingBtn').classList.toggle('active', tabName === 'listing');
    document.getElementById('purchaseBtn').classList.toggle('active', tabName === 'purchase');
}
</script>
</body>
</html>