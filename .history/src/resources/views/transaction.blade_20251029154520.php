            ...
            <div class="transaction-main__message-chat" id="chatMessages">
                @forelse($messages as $message)
                    ...
                    <div class="transaction-main__message-chat--item @if($message->sender_id === Auth::id()) message-item--right @else message-item--left @endif">
                        ...
                        @if($isMyMessage)
                        <div class="transaction-main__message-chat--item-content-actions">
                            <button type="button" class="btn-edit-message" data-message-id="{{ $message->id }}">編集</button>
                            <button type="button" class="btn-delete-message" data-message-id="{{ $message->id }}">削除</button>
                        </div>
                        @endif
                    </div>
                @empty
