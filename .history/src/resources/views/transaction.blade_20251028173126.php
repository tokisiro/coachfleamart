    ...
    <div class="transaction-side">
        ...
        <div class="transaction-side__list">
            @forelse($otherTransactions as $otherProduct)
                <a href="{{ route('transaction.show', $otherProduct->id) }}" class="transaction-side__item">
                    <img class="transaction-side__item-img" src="{{ asset($otherProduct->image) }}" alt="商品画像">
                    <p class="transaction-side__item-name">{{ $otherProduct->product_name }}</p>
                </a>
            @empty
