...
<header class="header">
    <div class="header-inner">
        ...
        <form class="header-inner__search" id="searchForm" action="/search" method="get">
            @csrf
            <input class="header-inner__search-input" type="text" name="query" placeholder="何をお探しですか？" value="{{ $searchTerm ?? '' }}" autocomplete="off">
            <input type="hidden" name="tab" value="{{ $mode ?? 'recommendation' }}">
        </form>
