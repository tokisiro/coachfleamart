...
<header class="header">
    <div class="header-inner">
        ...
        <form class="header-inner__search" id="searchForm" action="/search" method="">
            <input class="header-inner__search-input" type="text" name="query" placeholder="何をお探しですか？">
        </form>
        <div class="header-inner__metastasis">
            @if (Auth::check())
            <form class="header-inner__metastasis-situation" action="/logout" method="post" value="{{$input}}>
                @csrf
