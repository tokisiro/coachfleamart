        ...
        <div class="buy-content">
            ...
            <div class="buy-content__payment">
                ...
                <div class="buy-content__payment-select">
                    <select class="buy-content__payment-select--option" name="payment_method" id="payment-method">
...
<script>
    ...
    if (selectElement && displayTd) {
        // ページ読み込み時に選択されている値を反映
        if (selectElement.value === '選択してください') {
            displayTd.innerText = '';
        } else {
            displayTd.innerText = selectElement.value;
        }

        selectElement.addEventListener('change', () => {
            const selectedValue = selectElement.value;
            if (selectedValue === '選択してください') {
                displayTd.innerText = 'コンビニ';
            } else {
                displayTd.innerText = selectedValue;
            }
        });
    }
});
