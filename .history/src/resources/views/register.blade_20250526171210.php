        ...
        <form class="register-form" action="" method="post">
            ...
            <div class="register-form__password">
                <label class="register-form__password-label">
                    パスワード
                    <input class="register-form__password-label" type="text">
                </label>
            </div>
            <div class="register-form__confirmation">
                <label class="register-form__confirmation">
                    確認用パスワード
                    <input class="register-form__confirmation-label" type="text">
                </label>
            </div>
            <div class="register-form__button">
                <button class="register-form_button">
