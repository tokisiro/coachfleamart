...
<div class="transaction">
    ...
    <div class="transaction-main">
        ...
        <form class="transaction-main__message" id="messageForm" action="{{ route('messages', $detail->id) }}" method="POST" autocomplete="on">
            @csrf
            ...
            <div class="transaction-main__message-input">
                <input class="transaction-main__message-input--text" name="message" type="text" id="messageInput" placeholder="取引メッセージを入力してください">
