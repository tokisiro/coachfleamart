    ...
    <form class="sell">
        ...
        <div class="sell-category">
            ...
            <div class="sell-category__checkbox">
                ...
                <label class="sell-category__checkbox-label" id="category-toys">
                    おもちゃ
                    <input class="sell-category__checkbox-label--input" type="checkbox" id="category-toys" name="category" value="toys">
                </label>
