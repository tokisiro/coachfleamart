    ...
    <div class="transaction-main">
        ...
        <div id="ratingModal" class="transaction-main__modal" style="display: none;">
            <div class="transaction-main__modal-content">
                <span class="transaction-main__modal-content--close">&times;</span>
                <h2>相手を評価する</h2>
                <form id="ratingForm">
                @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const Status = '{{ $detail->transaction_status ?? '' }}';
    ...
    const imagePreviewContainer = document.querySelector('.transaction-main__message-input-image-preview-container');
