            ...
            <div class="transaction-main__message-chat" id="chatMessages">
                @forelse($messages as $message)
                    ...
                    <div class="transaction-main__message-chat--item @if($message->sender_id === Auth::id()) message-item--right @else message-item--left @endif">
                        ...
                        @php
                            $messageLength = mb_strlen($message->message); // 日本語文字数対応
                            $contentClass = '';
                        if ($messageLength > 50) { // 例: 50文字以上の場合
            $contentClass = 'message-content--long';
        } elseif ($messageLength > 20) { // 例: 20文字以上50文字以下の場合
            $contentClass = 'message-content--medium';
        } else { // それ以外（短いメッセージ）
            $contentClass = 'message-content--short';
        }
    @endphp
