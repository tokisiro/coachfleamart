    ...
    <form class="sell">
        ...
        <div class="sell-img">
            ...
            <div class="sell-img__icon">
                ...
                <input class="sell-img__icon-input" type="file" accept="image/*" style="display: none;">
            </div>
        </div>
        ...
        <div class="sell-status">
                ...
                <select class="sell-status__select" name="" >
                    <option value=""></option>
        ...
        <div class="sell-name">
            ...
            <input class="sell-name__input" type="text">
            </label>
        </div>
        <div class="sell-brand">
            <label class="sell-brand__label">
                ...
                <input class="sell-brand__input" type="text">
        </div>
        <div class="sell-explanation">
            <label class="sell-explanation__label">
                商品の説明
                </label>
                <input class="sell-explanation__input" type="textarea">
        </div>
        <div class="sell-price">
            <label class="sell-price__label">
                販売価格
                </label>
                <input class="sell-price__input" type="text" placeholder="¥">
        </div>
