...
<main>
    <div class="setting">
        ...
        <form class="setting-form">
            ...
            <!-- 目立たない隠しinput -->
            <input id="fileInput" class="setting-form__icon-input" type="file" style="display:none;">
            <!-- カスタムボタン -->
            <button type="button" class="custom-btn">画像を選択する</button>
            <!-- 非表示のテキスト -->
    <span class="no-file-text" style="display:none;">選択されていません</span>
            </div>
