...
@section('content')
    <form class="sell" action="/sell" method="post" enctype="multipart/form-data">
        ...
        <div class="sell-img">
            <label class="sell-img__label" for="image">
                商品画像
            </label>
            <div class="sell-img__icon">
                <img class="sell-img__icon-item" src="" alt="">
                <input class="sell-img__icon-input" type="file" name="image" id="image">
                <!-- カスタムボタン -->
                <button type="button" class="sell-img__icon-button">
                    画像を選択する
                </button>
            </div>
        ...
        <div class="sell-category">
            <div class="sell-category__label">
                <label class="sell-category__label-item" for="category-fashion">
                    カテゴリー
                </label>
            </div>
            <div class="sell-category__checkbox">
                ...
                <input class="sell-category__checkbox-input" type="checkbox" id="category-child" name="category_ids[]" value="ベビー・キッズ">
        ...
        <div class="sell-situation">
            <label class="sell-situation__label" for="situation">
                商品の状態
            </label>
            <select class="sell-situation__select" name="situation" id="situation" >
            <option value="" selected hidden>選択してください</option>
                <option class="sell-situation__select-option" value="良好">良好</option>
                <option class="sell-situation__select-option" value="目立った傷や汚れなし">目立った傷や汚れなし</option>
                <option class="sell-situation__select-option" value="やや傷や汚れあり">やや傷や汚れあり</option>
                <option class="sell-situation__select-option" value="状態が悪い">状態が悪い</option>
            </select>
        ...
        <div class="sell-explanation">
            ...
            <textarea class="sell-explanation__input" name="explanation" id="explanation"></textarea>
