...
<script>
  ...
  const myListDiv = document.querySelector('.myListBtn');
  ...
  recommendationBtn.addEventListener('click', () => {
    ...
    myListDiv.classList.remove('showList'); // これで隠す
  ...
  myListBtn.addEventListener('click', () => {
    ...
    myListDiv.classList.remove('showMyList'); // これで表示
    myListDiv.classList.add('showList');
  });
});
</script>
</body>
