...
<main>
    <div class="detail">
        ...
        <div class="detail-information">
            <div class="detail-information__title">

            </div>
        </div>
        <div class="detail-product__index">
            <h3 class="detail-product__index-item">
                商品説明
            </h3>
        </div>
        <div class="detail-product__color">
            <p class="detail-product__color-item">
                カラー：
            </p>
        </div>
        <div class="detail-product__explanation">
            <div class="detail-product__explanation-item">
            <!--商品の説明メッセージを表示-->
            </div>
        </div>
        <div class="detail-product__inde">
