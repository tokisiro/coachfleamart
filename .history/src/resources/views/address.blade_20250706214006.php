...
@section('content')
    <div class="setting">
        ...
        <form id="iconForm" class="setting-form" action="/mypage/profile" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="setting-form__icon">
                <img id="iconPreview" class="setting-form__icon-img" src="{{ $user->icon ? asset('storage/' . $user->icon) }}" alt="">
                <!-- 目立たない隠しinput -->
