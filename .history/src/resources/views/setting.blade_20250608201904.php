    ...
    <div class="setting">
        ...
        <form class="setting-form" action="/mypage/profile" method="post" enctype="multipart/form-data">
            ...
            <div class="setting-form__icon">
                ...
                <!-- 目立たない隠しinput -->
                <input class="setting-form__icon-input" type="file" name>
                <!-- カスタムボタン -->
            ...
            <div class="setting-form__name">
                ...
                <input class="setting-form__name-input" type="text" value="{{ old('name', $user->name ?? '') }}">
            </div>
            <div class="setting-form__post">
                <label class="setting-form__post-label">
                    郵便番号
                </label>
                <input class="setting-form__post-input" type="text" value="{{ old('post_code', $user->post_code ?? '') }}">
            </div>
            <div class="setting-form__address">
                <label class="setting-form__address-label">
                    住所
                </label>
                <input class="setting-form__address-input" type="text" value="{{ old('address', $user->address ?? '') }}">
            </div>
            <div class="setting-form__building">
                <label class="setting-form__building-label">
                    建物名
                </label>
                <input class="setting-form__building-input" type="text" value="{{ old('building', $user->building ?? '') }}">
            </div>
