...
<main>
    <form class="sell">
        ...
        <div class="sell-img">
            <label class="sell-img__">
            <img class="sell-form__icon-img" src="" alt="商品画像">
                <!-- 目立たない隠しinput -->
            <input class="sell-form__icon-input" type="file">
                <!-- カスタムボタン -->
            <button type="button" class="sell-form__icon-button">画像を選択する</button>
            </label>
        </div>
